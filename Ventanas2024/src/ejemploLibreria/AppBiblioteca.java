...
public class AppBiblioteca {
   ...
   private void bootStrap() {
       ...
       txtTitulo.setText(b1.getLibros()[0].getTitulo());        
       txtNombreAutor.setText(b1.getLibros()[0].getAutor());
       txtAnoPublicacion.setText(b1.getLibros()[0].getAnoPublicacion());
       txtEditorial.setText(b1.getLibros()[0].getEditorial());
       txtReferenciaBibliografica.setText(b1.getLibros()[0].getReferenciaBibliografica());
